...
class com_amap_api_maps_offlinemap_OfflineMapManager extends java_lang_Object  {
  ...
  Future<void> setOnOfflineLoadedListener(com_amap_api_maps_offlinemap_OfflineMapManager_OfflineLoadedListener var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.offlinemap.OfflineMapManager::setOnOfflineLoadedListener', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
