...
class com_amap_api_maps_model_Marker extends com_amap_api_maps_model_BasePointOverlay  {
  ...
  Future<void> setIcons(List<com_amap_api_maps_model_BitmapDescriptor> var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.Marker::setIcons', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
  ...
  Future<com_autonavi_amap_mapcore_IPoint> getGeoPoint() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.Marker::getGeoPoint', {"refId": refId});
...
extension com_amap_api_maps_model_Marker_Batch on List<com_amap_api_maps_model_Marker> {
  ...
  Future<List<com_autonavi_amap_mapcore_IPoint>> getGeoPoint_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.Marker::getGeoPoint_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
  ...
  Future<List<com_amap_api_maps_model_MarkerOptions>> getOptions_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_maps_model_MarkerOptions()..refId = __result__..tag__ = 'amap_map_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
