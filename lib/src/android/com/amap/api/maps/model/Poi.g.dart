...
class com_amap_api_maps_model_Poi extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<com_amap_api_maps_model_Poi> create__String__com_amap_api_maps_model_LatLng__String(String var1, com_amap_api_maps_model_LatLng var2, String var3) async {
    ...
    final object = com_amap_api_maps_model_Poi()..refId = refId..tag__ = 'amap_map_fluttify';
  ...
  static Future<List<com_amap_api_maps_model_Poi>> create_batch__String__com_amap_api_maps_model_LatLng__String(List<String> var1, List<com_amap_api_maps_model_LatLng> var2, List<String> var3) async {
    ...
    final List<com_amap_api_maps_model_Poi> typedResult = resultBatch.map((result) => com_amap_api_maps_model_Poi()..refId = result..tag__ = 'amap_map_fluttify').toList();
  ...
  //region getters
  static Future<com_amap_api_maps_model_PoiCreator> get_CREATOR() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod("com.amap.api.maps.model.Poi::get_CREATOR", );
    kNativeObjectPool.add(com_amap_api_maps_model_PoiCreator()..refId = __result__..tag__ = 'amap_map_fluttify');
    return com_amap_api_maps_model_PoiCreator()..refId = __result__..tag__ = 'amap_map_fluttify';
  }
  ...
  Future<String> getName() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.Poi::getName', {"refId": refId});
  ...
  Future<com_amap_api_maps_model_LatLng> getCoordinate() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.Poi::getCoordinate', {"refId": refId});
  ...
  Future<String> getPoiId() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.Poi::getPoiId', {"refId": refId});
...
extension com_amap_api_maps_model_Poi_Batch on List<com_amap_api_maps_model_Poi> {
  //region getters
  Future<List<com_amap_api_maps_model_PoiCreator>> get_CREATOR_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod("com.amap.api.maps.model.Poi::get_CREATOR_batch", [for (final __item__ in this) {'refId': __item__.refId}]);
    final typedResult = (resultBatch as List).cast<int>().map((__result__) => com_amap_api_maps_model_PoiCreator()..refId = __result__..tag__ = 'amap_map_fluttify').toList();
    kNativeObjectPool.addAll(typedResult);
    return typedResult;
  }
