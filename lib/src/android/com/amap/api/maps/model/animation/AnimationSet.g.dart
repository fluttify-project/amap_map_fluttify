...
class com_amap_api_maps_model_animation_AnimationSet extends com_amap_api_maps_model_animation_Animation  {
  ...
  static Future<List<com_amap_api_maps_model_animation_AnimationSet>> create_batch__boolean(List<bool> var1) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('ObjectFactory::create_batchcom_amap_api_maps_model_animation_AnimationSet__boolean', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__]}]);
  ...
  Future<void> addAnimation(com_amap_api_maps_model_animation_Animation var1) async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.animation.AnimationSet::addAnimation', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
  ...
  Future<void> cleanAnimation() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.animation.AnimationSet::cleanAnimation', {"refId": refId});
...
extension com_amap_api_maps_model_animation_AnimationSet_Batch on List<com_amap_api_maps_model_animation_AnimationSet> {
  ...
  Future<List<void>> addAnimation_batch(List<com_amap_api_maps_model_animation_Animation> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.animation.AnimationSet::addAnimation_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].refId, "refId": this[__i__].refId}]);
  ...
  Future<List<void>> cleanAnimation_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.animation.AnimationSet::cleanAnimation_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
