...
class com_amap_api_maps_model_CameraPositionCreator extends java_lang_Object  {
  ...
  static Future<com_amap_api_maps_model_CameraPositionCreator> create__() async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_map_fluttify'))).invokeMethod('ObjectFactory::createcom_amap_api_maps_model_CameraPositionCreator__', );
  ...
  static Future<List<com_amap_api_maps_model_CameraPositionCreator>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_map_fluttify'))).invokeMethod('ObjectFactory::create_batchcom_amap_api_maps_model_CameraPositionCreator__', {'length': length});
