...
extension com_amap_api_maps_model_LatLngBounds_Builder_Batch on List<com_amap_api_maps_model_LatLngBounds_Builder> {
  ...
  Future<List<com_amap_api_maps_model_LatLngBounds_Builder>> include_batch(List<com_amap_api_maps_model_LatLng> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.LatLngBounds.Builder::include_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i].refId}]);
  ...
  Future<List<com_amap_api_maps_model_LatLngBounds>> build_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.LatLngBounds.Builder::build_batch', );
