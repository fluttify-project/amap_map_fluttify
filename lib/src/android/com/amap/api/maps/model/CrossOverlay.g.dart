...
extension com_amap_api_maps_model_CrossOverlay_Batch on List<com_amap_api_maps_model_CrossOverlay> {
  ...
  Future<List<int>> setData_batch(List<Uint8List> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.CrossOverlay::setData_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i]}]);
  ...
  Future<void> setAttribute_batch(List<com_autonavi_ae_gmap_gloverlay_GLCrossVector_AVectorCrossAttr> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.CrossOverlay::setAttribute_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i].refId}]);
  ...
  Future<void> setVisible_batch(List<bool> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.CrossOverlay::setVisible_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i]}]);
  ...
  Future<void> remove_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.CrossOverlay::remove_batch', );
  ...
  Future<void> setImageMode_batch(List<bool> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.CrossOverlay::setImageMode_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i]}]);
