...
class com_amap_api_maps_model_ArcOptionsCreator extends java_lang_Object  {
  ...
  static Future<List<com_amap_api_maps_model_ArcOptionsCreator>> create_batch__(int length) async {
    ...
    final List<com_amap_api_maps_model_ArcOptionsCreator> typedResult = resultBatch.map((result) => com_amap_api_maps_model_ArcOptionsCreator()..refId = result..tag = 'amap_map_fluttify').toList();
