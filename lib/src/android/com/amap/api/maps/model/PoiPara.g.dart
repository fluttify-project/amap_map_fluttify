...
extension com_amap_api_maps_model_PoiPara_Batch on List<com_amap_api_maps_model_PoiPara> {
  ...
  Future<List<com_amap_api_maps_model_LatLng>> getCenter_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.PoiPara::getCenter_batch', );
  ...
  Future<void> setCenter_batch(List<com_amap_api_maps_model_LatLng> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.PoiPara::setCenter_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i].refId}]);
  ...
  Future<List<String>> getKeywords_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.PoiPara::getKeywords_batch', );
  ...
  Future<void> setKeywords_batch(List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.PoiPara::setKeywords_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i]}]);
