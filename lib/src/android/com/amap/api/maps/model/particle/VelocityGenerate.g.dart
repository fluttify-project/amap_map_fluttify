...
extension com_amap_api_maps_model_particle_VelocityGenerate_Batch on List<com_amap_api_maps_model_particle_VelocityGenerate> {
  ...
  Future<List<double>> getX_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.particle.VelocityGenerate::getX_batch', );
  ...
  Future<List<double>> getY_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.particle.VelocityGenerate::getY_batch', );
  ...
  Future<List<double>> getZ_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.particle.VelocityGenerate::getZ_batch', );
