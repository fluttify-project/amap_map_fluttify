...
extension com_amap_api_maps_model_TileOverlay_Batch on List<com_amap_api_maps_model_TileOverlay> {
  ...
  Future<void> remove_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.TileOverlay::remove_batch', );
  ...
  Future<void> clearTileCache_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.TileOverlay::clearTileCache_batch', );
  ...
  Future<List<String>> getId_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.TileOverlay::getId_batch', );
  ...
  Future<void> setZIndex_batch(List<double> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.TileOverlay::setZIndex_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i]}]);
  ...
  Future<List<double>> getZIndex_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.TileOverlay::getZIndex_batch', );
  ...
  Future<void> setVisible_batch(List<bool> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.TileOverlay::setVisible_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i]}]);
  ...
  Future<List<bool>> isVisible_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.TileOverlay::isVisible_batch', );
