...
extension com_amap_api_maps_model_RouteOverlay_Batch on List<com_amap_api_maps_model_RouteOverlay> {
  ...
  Future<void> removeRouteName_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.RouteOverlay::removeRouteName_batch', );
  ...
  Future<void> remove_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.amap.api.maps.model.RouteOverlay::remove_batch', );
