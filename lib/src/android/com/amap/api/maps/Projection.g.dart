...
class com_amap_api_maps_Projection extends java_lang_Object  {
  ...
  Future<android_graphics_PointF> toOpenGLLocation(com_amap_api_maps_model_LatLng var1) async {
    ...
    if (__result__ == null) {
      ...
      kNativeObjectPool.add(android_graphics_PointF()..refId = __result__..tag__ = 'amap_map_fluttify');
      return android_graphics_PointF()..refId = __result__..tag__ = 'amap_map_fluttify';
    }
  }
...
extension com_amap_api_maps_Projection_Batch on List<com_amap_api_maps_Projection> {
  ...
  Future<List<android_graphics_PointF>> toOpenGLLocation_batch(List<com_amap_api_maps_model_LatLng> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => android_graphics_PointF()..refId = __result__..tag__ = 'amap_map_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_maps_model_VisibleRegion>> getVisibleRegion_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_maps_model_VisibleRegion()..refId = __result__..tag__ = 'amap_map_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_maps_model_TileProjection>> fromBoundsToTile_batch(List<com_amap_api_maps_model_LatLngBounds> var1, List<int> var2, List<int> var3) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_maps_model_TileProjection()..refId = __result__..tag__ = 'amap_map_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_maps_model_AMapCameraInfo>> getCameraInfo_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_maps_model_AMapCameraInfo()..refId = __result__..tag__ = 'amap_map_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
