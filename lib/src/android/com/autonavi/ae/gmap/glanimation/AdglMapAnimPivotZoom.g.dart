...
class com_autonavi_ae_gmap_glanimation_AdglMapAnimPivotZoom extends com_autonavi_ae_gmap_glanimation_AbstractAdglAnimation  {
  //region constants
  static const String name__ = 'com.autonavi.ae.gmap.glanimation.AdglMapAnimPivotZoom';
  ...
  static Future<com_autonavi_ae_gmap_glanimation_AdglMapAnimPivotZoom> create__int(int var1) async {
    ...
    final object = com_autonavi_ae_gmap_glanimation_AdglMapAnimPivotZoom()..refId = refId..tag__ = 'amap_map_fluttify';
  ...
  static Future<List<com_autonavi_ae_gmap_glanimation_AdglMapAnimPivotZoom>> create_batch__int(List<int> var1) async {
    ...
    final List<com_autonavi_ae_gmap_glanimation_AdglMapAnimPivotZoom> typedResult = resultBatch.map((result) => com_autonavi_ae_gmap_glanimation_AdglMapAnimPivotZoom()..refId = result..tag__ = 'amap_map_fluttify').toList();
  ...
  Future<void> reset() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.ae.gmap.glanimation.AdglMapAnimPivotZoom::reset', {"refId": refId});
  ...
  Future<void> commitAnimation(Object var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.ae.gmap.glanimation.AdglMapAnimPivotZoom::commitAnimation', {"var1": var1, "refId": refId});
  ...
  Future<void> setToMapZoomAndPivot(double var1, int var2, android_graphics_Point var3) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.ae.gmap.glanimation.AdglMapAnimPivotZoom::setToMapZoomAndPivot', {"var1": var1, "var2": var2, "var3": var3.refId, "refId": refId});
...
extension com_autonavi_ae_gmap_glanimation_AdglMapAnimPivotZoom_Batch on List<com_autonavi_ae_gmap_glanimation_AdglMapAnimPivotZoom> {
  ...
  Future<List<void>> setToMapZoomAndPivot_batch(List<double> var1, List<int> var2, List<android_graphics_Point> var3) async {
