...
extension com_autonavi_amap_mapcore_FileUtil_Batch on List<com_autonavi_amap_mapcore_FileUtil> {
  ...
  Future<List<String>> getMapBaseStorage_batch(List<android_content_Context> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FileUtil::getMapBaseStorage_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i].refId}]);
  ...
  Future<List<String>> getExternalStroragePath_batch(List<android_content_Context> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FileUtil::getExternalStroragePath_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i].refId}]);
  ...
  Future<void> writeDatasToFile_batch(List<String> var0, List<Uint8List> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FileUtil::writeDatasToFile_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var1": var1[i]}]);
  ...
  Future<List<Uint8List>> readFileContents_batch(List<String> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FileUtil::readFileContents_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i]}]);
  ...
  Future<void> createNoMediaFileIfNotExist_batch(List<String> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FileUtil::createNoMediaFileIfNotExist_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i]}]);
  ...
  Future<void> saveFile_batch(List<String> var0, List<String> var1, List<bool> var2) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FileUtil::saveFile_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var1": var1[i], "var2": var2[i]}]);
  ...
  Future<List<Uint8List>> readFileContentsFromAssets_batch(List<android_content_Context> var0, List<String> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FileUtil::readFileContentsFromAssets_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i].refId, "var1": var1[i]}]);
  ...
  Future<List<String>> getName_batch(List<String> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FileUtil::getName_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i]}]);
  ...
  Future<List<int>> indexOfLastSeparator_batch(List<String> var0) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FileUtil::indexOfLastSeparator_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i]}]);
