...
extension com_autonavi_amap_mapcore_VirtualEarthProjection_Batch on List<com_autonavi_amap_mapcore_VirtualEarthProjection> {
  ...
  Future<List<double>> clip_batch(List<double> var0, List<double> var2, List<double> var4) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.VirtualEarthProjection::clip_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var2": var2[i], "var4": var4[i]}]);
  ...
  Future<List<android_graphics_Point>> latLongToPixels__int__int__int_batch(List<int> var0, List<int> var1, List<int> var2) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.VirtualEarthProjection::latLongToPixels__int__int__int_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var1": var1[i], "var2": var2[i]}]);
  ...
  Future<List<android_graphics_Point>> latLongToPixels__double__double__int_batch(List<double> var0, List<double> var2, List<int> var4) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.VirtualEarthProjection::latLongToPixels__double__double__int_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var2": var2[i], "var4": var4[i]}]);
  ...
  Future<List<com_autonavi_amap_mapcore_DPoint>> pixelsToLatLong_batch(List<int> var0, List<int> var2, List<int> var4) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.VirtualEarthProjection::pixelsToLatLong_batch', [for (int i = 0; i < this.length; i++) {"var0": var0[i], "var2": var2[i], "var4": var4[i]}]);
