...
class _com_autonavi_amap_mapcore_interfaces_IInfoWindowManager_SUB extends java_lang_Object with com_autonavi_amap_mapcore_interfaces_IInfoWindowManager {}

mixin com_autonavi_amap_mapcore_interfaces_IInfoWindowManager on java_lang_Object {
  

  static com_autonavi_amap_mapcore_interfaces_IInfoWindowManager subInstance() => _com_autonavi_amap_mapcore_interfaces_IInfoWindowManager_SUB();
...
extension com_autonavi_amap_mapcore_interfaces_IInfoWindowManager_Batch on List<com_autonavi_amap_mapcore_interfaces_IInfoWindowManager> {
  //region methods
  ...
  Future<List<void>> setInfoWindowAppearAnimation_batch(List<com_amap_api_maps_model_animation_Animation> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.interfaces.IInfoWindowManager::setInfoWindowAppearAnimation_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].refId, "refId": this[__i__].refId}]);
  ...
  Future<List<void>> setInfoWindowBackColor_batch(List<int> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.interfaces.IInfoWindowManager::setInfoWindowBackColor_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<void>> setInfoWindowBackEnable_batch(List<bool> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.interfaces.IInfoWindowManager::setInfoWindowBackEnable_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<void>> setInfoWindowBackScale_batch(List<double> var1, List<double> var2) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.interfaces.IInfoWindowManager::setInfoWindowBackScale_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__], "refId": this[__i__].refId}]);
  ...
  Future<List<void>> setInfoWindowDisappearAnimation_batch(List<com_amap_api_maps_model_animation_Animation> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.interfaces.IInfoWindowManager::setInfoWindowDisappearAnimation_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].refId, "refId": this[__i__].refId}]);
  ...
  Future<List<void>> setInfoWindowMovingAnimation_batch(List<com_amap_api_maps_model_animation_Animation> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.interfaces.IInfoWindowManager::setInfoWindowMovingAnimation_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].refId, "refId": this[__i__].refId}]);
  ...
  Future<List<void>> startAnimation_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.interfaces.IInfoWindowManager::startAnimation_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
