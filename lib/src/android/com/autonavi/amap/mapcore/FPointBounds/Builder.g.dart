...
extension com_autonavi_amap_mapcore_FPointBounds_Builder_Batch on List<com_autonavi_amap_mapcore_FPointBounds_Builder> {
  ...
  Future<List<com_autonavi_amap_mapcore_FPointBounds_Builder>> include_batch(List<com_autonavi_amap_mapcore_FPoint> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds.Builder::include_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i].refId}]);
  ...
  Future<List<com_autonavi_amap_mapcore_FPointBounds>> build_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds.Builder::build_batch', );
