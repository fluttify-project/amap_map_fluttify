...
extension com_autonavi_amap_mapcore_FPointBounds_Batch on List<com_autonavi_amap_mapcore_FPointBounds> {
  ...
  Future<List<bool>> contains__com_autonavi_amap_mapcore_FPoint_batch(List<com_autonavi_amap_mapcore_FPoint> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::contains__com_autonavi_amap_mapcore_FPoint_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i].refId}]);
  ...
  Future<List<bool>> contains__com_autonavi_amap_mapcore_FPointBounds_batch(List<com_autonavi_amap_mapcore_FPointBounds> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::contains__com_autonavi_amap_mapcore_FPointBounds_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i].refId}]);
  ...
  Future<List<bool>> intersects_batch(List<com_autonavi_amap_mapcore_FPointBounds> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::intersects_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i].refId}]);
