...
class com_autonavi_amap_mapcore_FPointBounds extends java_lang_Object  {
  //region constants
  static const String name__ = 'com.autonavi.amap.mapcore.FPointBounds';
  ...
  static Future<com_autonavi_amap_mapcore_FPointBounds> create__com_autonavi_amap_mapcore_FPoint__com_autonavi_amap_mapcore_FPoint(com_autonavi_amap_mapcore_FPoint var1, com_autonavi_amap_mapcore_FPoint var2) async {
    ...
    final object = com_autonavi_amap_mapcore_FPointBounds()..refId = refId..tag__ = 'amap_map_fluttify';
  ...
  static Future<List<com_autonavi_amap_mapcore_FPointBounds>> create_batch__com_autonavi_amap_mapcore_FPoint__com_autonavi_amap_mapcore_FPoint(List<com_autonavi_amap_mapcore_FPoint> var1, List<com_autonavi_amap_mapcore_FPoint> var2) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('ObjectFactory::create_batchcom_autonavi_amap_mapcore_FPointBounds__com_autonavi_amap_mapcore_FPoint__com_autonavi_amap_mapcore_FPoint', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__].refId, "var2": var2[__i__].refId}]);
  
    final List<com_autonavi_amap_mapcore_FPointBounds> typedResult = resultBatch.map((result) => com_autonavi_amap_mapcore_FPointBounds()..refId = result..tag__ = 'amap_map_fluttify').toList();
  ...
  static Future<com_autonavi_amap_mapcore_FPointBounds_Builder> builder() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::builder', );
  ...
  Future<bool> contains__com_autonavi_amap_mapcore_FPoint(com_autonavi_amap_mapcore_FPoint var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::contains__com_autonavi_amap_mapcore_FPoint', {"var1": var1.refId, "refId": refId});
  ...
  Future<bool> contains__com_autonavi_amap_mapcore_FPointBounds(com_autonavi_amap_mapcore_FPointBounds var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::contains__com_autonavi_amap_mapcore_FPointBounds', {"var1": var1.refId, "refId": refId});
  ...
  Future<bool> intersects(com_autonavi_amap_mapcore_FPointBounds var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::intersects', {"var1": var1.refId, "refId": refId});
...
extension com_autonavi_amap_mapcore_FPointBounds_Batch on List<com_autonavi_amap_mapcore_FPointBounds> {
  ...
  Future<List<com_autonavi_amap_mapcore_FPointBounds_Builder>> builder_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::builder_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
  ...
  Future<List<bool>> contains__com_autonavi_amap_mapcore_FPoint_batch(List<com_autonavi_amap_mapcore_FPoint> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::contains__com_autonavi_amap_mapcore_FPoint_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].refId, "refId": this[__i__].refId}]);
  ...
  Future<List<bool>> contains__com_autonavi_amap_mapcore_FPointBounds_batch(List<com_autonavi_amap_mapcore_FPointBounds> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::contains__com_autonavi_amap_mapcore_FPointBounds_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].refId, "refId": this[__i__].refId}]);
  ...
  Future<List<bool>> intersects_batch(List<com_autonavi_amap_mapcore_FPointBounds> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.FPointBounds::intersects_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].refId, "refId": this[__i__].refId}]);
