...
class com_autonavi_amap_mapcore_maploader_AMapLoader_AMapGridDownloadRequest extends java_lang_Object  {
  ...
  static Future<com_autonavi_amap_mapcore_maploader_AMapLoader_AMapGridDownloadRequest> create__android_content_Context__String__String(android_content_Context var1, String var2, String var3) async {
    ...
    final object = com_autonavi_amap_mapcore_maploader_AMapLoader_AMapGridDownloadRequest()..refId = refId..tag__ = 'amap_map_fluttify';
  ...
  static Future<List<com_autonavi_amap_mapcore_maploader_AMapLoader_AMapGridDownloadRequest>> create_batch__android_content_Context__String__String(List<android_content_Context> var1, List<String> var2, List<String> var3) async {
    ...
    final List<com_autonavi_amap_mapcore_maploader_AMapLoader_AMapGridDownloadRequest> typedResult = resultBatch.map((result) => com_autonavi_amap_mapcore_maploader_AMapLoader_AMapGridDownloadRequest()..refId = result..tag__ = 'amap_map_fluttify').toList();
  ...
  Future<Map<String,String>> getRequestHead() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint('fluttify-dart: com.autonavi.amap.mapcore.maploader.AMapLoader.AMapGridDownloadRequest@$refId::getRequestHead([])');
    }
  ...
  Future<Map<String,String>> getParams() async {
    // print log
    if (fluttifyLogEnabled) {
      debugPrint('fluttify-dart: com.autonavi.amap.mapcore.maploader.AMapLoader.AMapGridDownloadRequest@$refId::getParams([])');
    }
  ...
  Future<String> getURL() async {
    // print log
    if (fluttifyLogEnabled) {
      debugPrint('fluttify-dart: com.autonavi.amap.mapcore.maploader.AMapLoader.AMapGridDownloadRequest@$refId::getURL([])');
    }
  
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.maploader.AMapLoader.AMapGridDownloadRequest::getURL', {"refId": refId});
  ...
  Future<void> setPostEntityBytes(Uint8List var1) async {
    // print log
    if (fluttifyLogEnabled) {
      debugPrint('fluttify-dart: com.autonavi.amap.mapcore.maploader.AMapLoader.AMapGridDownloadRequest@$refId::setPostEntityBytes([\'var1\':$var1])');
    }
  
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.maploader.AMapLoader.AMapGridDownloadRequest::setPostEntityBytes', {"var1": var1, "refId": refId});
  ...
  Future<Uint8List> getEntityBytes() async {
    // print log
    if (fluttifyLogEnabled) {
      debugPrint('fluttify-dart: com.autonavi.amap.mapcore.maploader.AMapLoader.AMapGridDownloadRequest@$refId::getEntityBytes([])');
    }
  
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify').invokeMethod('com.autonavi.amap.mapcore.maploader.AMapLoader.AMapGridDownloadRequest::getEntityBytes', {"refId": refId});
...
extension com_autonavi_amap_mapcore_maploader_AMapLoader_AMapGridDownloadRequest_Batch on List<com_autonavi_amap_mapcore_maploader_AMapLoader_AMapGridDownloadRequest> {
  ...
  Future<List<void>> setPostEntityBytes_batch(List<Uint8List> var1) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
