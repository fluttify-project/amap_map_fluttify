...
public class SubHandler26 {
    public static Map<String, Handler> getSubHandler(BinaryMessenger messenger) {
        return new HashMap<String, Handler>() {{
            ...
            // factory
            put("ObjectFactory::create_batchcom_amap_api_maps_model_RouteOverlay__com_autonavi_ae_gmap_gloverlay_BaseRouteOverlay", (__argsBatch__, __methodResult__) -> {
                List<Integer> __resultList__ = new ArrayList<>();
            ...
            // factory
            put("ObjectFactory::create_batchcom_amap_api_maps_model_MultiPointOverlay__com_autonavi_amap_mapcore_interfaces_IMultiPointOverlay", (__argsBatch__, __methodResult__) -> {
                List<Integer> __resultList__ = new ArrayList<>();
